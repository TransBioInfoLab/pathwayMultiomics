#' Example Low-Signal Multi-Omics Pathway Results
#'
#' @description An example of the input data to the MiniMax statistic with weak
#'    biological (synthetic) signal
#'
...
#'    this file are from a low-signal scenario (for the treatment group, 20% of
